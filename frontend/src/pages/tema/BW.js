...
const BW2 = () =>{
    return (
     ...
     <section>
     <Button style={{borderColor:"#FFF",backgroundColor:"#000",color:"#fff",zIndex:"10",position:"absolute",top:"10px",borderRadius:"20px",color:"white",borderColor:"white",right:"10px",width:"auto"}}><AiFillPlayCircle/><span style={{margin:"20px"}}>Play Music</span></Button>
            
            <div style={{backgroundColor:"#444444",width:"auto",height:"560px"}}>
            <Row style={{zIndex:"2",position:"absolute",color:"#fff",marginTop:"50px"}}>
            ...
            <section>
              <p style={{fontFamily:"Corinthia",fontSize:"80px",color:"#000"}}>Penyelenggara</p>
          ...
          <Col
              ...
              <link href="https://fonts.googleapis.com/css?family=Caveat" rel="stylesheet"></link>
                ...
                <Button style={{backgroundColor:"#444444",borderColor:"#444444",borderRadius:"20px"}}>
                <a
                href="."
                style={{ color: "white" }}
                target="_blank" 
          ...
          <div style={{backgroundColor:"#444444",width:"auto",height:"350px",marginTop:"50px"}}>
          <Row>
          <p  style={{zIndex:"2",position:"absolute",color:"#fff",marginTop:"50px"}}>Qs Ar-Rum 21</p>
          
          <p style={{color:"#fff",marginTop:"150px"}}>“Dan diantara tanda-tanda (kebesarann)-Nya ialah Dia menciptakan pasangan-pasangan untukmu dari jenismu sendiri, agar kamu cenderung dan merasa tentram kepadanya, dan Dia menjadikan di antaramu rasa kasih dan sayang”</p>
          </Row>
           </div>
          <p style={{fontFamily:"Corinthia",fontSize:"80px",color:"#000"}}>Galery</p>
              <link href="https://fonts.googleapis.com/css?family=Corinthia" rel="stylesheet"></link>
            </section>
            <Row className="justify-content-md-center">
            <Col
          ...
          <Col
            ...
            <p style={{fontFamily:"Corinthia",fontSize:"80px",color:"#000"}}>Lokasi</p>
              <link href="https://fonts.googleapis.com/css?family=Corinthia" rel="stylesheet"></link>
              <Card style={{backgroundColor:"#444444",width:"auto ",marginTop:"50px"}}>
              <Row>
          ...
          <Col
              ...
              >
                ...
                <p>Sampai Selesai</p>
                <Button style={{backgroundColor:"#000",borderColor:"#fff",borderRadius:"20px",width:"auto"}}>Lihat Lokasi</Button>
                  </Card.Text>
          ...
          <Col
              ...
              >
                ...
                <p>Sampai Selesai</p>
                <Button style={{backgroundColor:"#000",borderColor:"#fff",borderRadius:"15px",width:"auto"}}>Lihat Lokasi</Button>
                  </Card.Text>
          ...
          <Col
              ...
              <p style={{fontFamily:"Corinthia",fontSize:"80px",color:"#000",marginTop:"40px"}}>Map Lokasi</p>
            
             <img src={require('../../image/maps.png')} style={{width:"400px",position:"relative"}}/>
             <p><Button style={{backgroundColor:"#000",borderColor:"#fff",marginTop:"50px",borderRadius:"20px",width:"auto"}}href="https://www.google.com/maps/@0.9142272,104.5037056,14z">View Maps</Button></p>
            
            
            
            
            </section>
            <div style={{backgroundColor:"#444444",width:"auto",height:"460px",marginTop:"50px"}}>
             <section style={{marginTop:"50px"}}>
              <p style={{fontFamily:"Corinthia",fontSize:"70px",color:"#fff",marginTop:"170px"}}>Ampau Cashless</p>
              <link href="https://fonts.googleapis.com/css?family=Corinthia" rel="stylesheet"></link>
              <p style={{color:"#fff",fontSize:"15px"}}>Tanpa mengurangi rasa hormat , bagi anda yang ingin memberi tanda kasih untuk kami melalui</p>
              <p style={{color:"#fff",fontSize:"15px"}}>Mandiri</p>
              <p style={{color:"#fff",fontSize:"15px"}}>Yunita Andriani</p>
              <p style={{color:"#fff",fontSize:"15px"}}>1020009931731</p>
              <Button style={{backgroundColor:"#000",borderColor:"#fff",borderRadius:"15px",width:"auto"}}>
              Copy No. Rekening
              </Button>
              <p style={{marginTop:"20px"}}><Button style={{backgroundColor:"#000",borderColor:"#fff",borderRadius:"15px",width:"auto"}}>Konfirmasi Hadiah</Button></p>
...
<section style={{backgroundColor:"#fff"}}>
          ...
          <Form style={{textAlign:"center"}}>
            ...
            <br></br>
            <input placeholder='Ucapan & Doa' style={{height:"60px",marginTop:"30px",backgrounColor:"#000"}}type="text"></input>
          <br></br>
          <Button style={{backgroundColor:"#000",borderColor:"#fff",marginTop:"30px",borderRadius:"20px"}}>Kirim</Button></Form>
